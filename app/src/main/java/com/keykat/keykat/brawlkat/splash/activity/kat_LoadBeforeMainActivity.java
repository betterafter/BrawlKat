package com.keykat.keykat.brawlkat.splash.activity;
...
public class kat_LoadBeforeMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(this.getClass().getName().equals("com.keykat.keykat.brawlkat.splash.activity.kat_LoadBeforeMainActivity")) {
