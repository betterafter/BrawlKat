...
public class kat_ActionBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        else if(intent.getAction().equals("com.keykat.keykat.brawlkat.kat_Service_BrawlStarsNotifActivity.CHECK_START")){
            isThreaStop = false;
            if(checkThread != null) checkThread = null;
            checkThread = new BrawlStarsPlayCheckThread(context);
            checkThread.start();
        }
        else if(intent.getAction().equals("com.keykat.keykat.brawlkat.kat_Service_BrawlStarsNotifActivity.CHECK_END")){
            isThreaStop = true;
        }
    }
