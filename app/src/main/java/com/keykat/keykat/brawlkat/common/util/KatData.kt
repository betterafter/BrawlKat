...
import com.keykat.keykat.brawlkat.common.util.database.*
import com.keykat.keykat.brawlkat.common.util.network.Client
import com.keykat.keykat.brawlkat.common.util.parser.*
import com.keykat.keykat.brawlkat.common.util.parser.kat_eventsParser.pair
import com.keykat.keykat.brawlkat.common.util.parser.kat_mapsParser.mapData
import com.keykat.keykat.brawlkat.common.util.parser.kat_official_BrawlerRankingParser.brawlerRankingData
import com.keykat.keykat.brawlkat.common.util.parser.kat_official_PowerPlaySeasonParser.powerPlaySeasonsData
import com.keykat.keykat.brawlkat.common.util.parser.kat_official_PowerPlaySeasonRankingParser.powerPlaySeasonRankingData
import java.util.*
...
object KatData {
    ...
    @JvmField
    val eventsPlayerData = MutableLiveData<kat_official_playerInfoParser.playerData>()
