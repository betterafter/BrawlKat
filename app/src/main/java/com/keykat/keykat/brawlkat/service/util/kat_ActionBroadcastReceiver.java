...
//
//        if (intent.getAction().equals(context.getString(R.string.screen_on))) {
//            SharedPreferences sharedPreferences
//                    = PreferenceManager.getDefaultSharedPreferences(context);
//            if (sharedPreferences.getBoolean(
//                    context.getString(R.string.notify_service),
//                    false
//            )) {
//                isThreaStop = false;
...
//                checkThread.start();
//            }
//        } else if (intent.getAction().equals(context.getString(R.string.screen_off))) {
//            isThreaStop = true;
...
//                    if (getTopPackageName(context).toLowerCase().contains(
