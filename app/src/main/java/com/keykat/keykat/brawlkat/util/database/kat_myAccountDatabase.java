package com.keykat.keykat.brawlkat.util.database;
...
public class kat_myAccountDatabase extends SQLiteOpenHelper {
    ...
    public kat_myAccountDatabase(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
